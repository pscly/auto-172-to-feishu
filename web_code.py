...
class WebClient:
    ...
    def _get_client(self) -> httpx.Client:
        ...
        if self._client is None or self._client.is_closed:
            ...
            self._client = httpx.Client(headers=self.headers, follow_redirects=True, timeout=10.0)
        return self._client
...
class AllKa:
    ...
    def get_all_ka(self):
        ...
        for item in all_data['data']:
            ...
            item_data['推广链接'] = f"https://h5.lot-ml.com/h5orderEn/index?pudID={item['sn']}&userid={self.uid}"
